	...
	public void process(List<ConsumerRecord<K, V>> records, Consumer<K, V> consumer,
		...
		if (SeekUtils.doSeeks((List) records, consumer, exception, recoverable,
			...
			if (EOSMode.V1.equals(eosMode.getMode())) {
				...
				TopicPartition partition = new TopicPartition(skipped.topic(), skipped.partition());
				this.kafkaTemplate.sendOffsetsToTransaction(
						Collections.singletonMap(partition, createOffsetAndMetadata(container, skipped.offset() + 1)));
			}
		}
