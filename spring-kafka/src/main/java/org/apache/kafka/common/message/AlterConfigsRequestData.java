...
public class AlterConfigsRequestData implements ApiMessage {
    ...
    public static final Schema SCHEMA_2 =
        new Schema(
            new Field("resources", new CompactArrayOf(AlterConfigsResource.SCHEMA_2), "The updates for each resource."),
            new Field("validate_only", Type.BOOLEAN, "True if we should validate the request, but not change the configurations."),
    ...
    public AlterConfigsRequestData duplicate() {
        AlterConfigsRequestData _duplicate = new AlterConfigsRequestData();
    ...
    public static class AlterConfigsResource implements Message, ImplicitLinkedHashMultiCollection.Element {
        ...
        public static final Schema SCHEMA_2 =
            new Schema(
                ...
                new Field("configs", new CompactArrayOf(AlterableConfig.SCHEMA_2), "The configurations."),
                TaggedFieldsSection.of(
                )
            );
