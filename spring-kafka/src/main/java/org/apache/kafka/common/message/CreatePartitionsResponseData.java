...
public class CreatePartitionsResponseData implements ApiMessage {
    int throttleTimeMs;
    List<CreatePartitionsTopicResult> results;
    ...
    public CreatePartitionsResponseData() {
        ...
        this.results = new ArrayList<CreatePartitionsTopicResult>(0);
    }
        ...
        this.throttleTimeMs = _readable.readInt();
        {
            if (_version >= 2) {
                ...
                if (arrayLength < 0) {
                    ...
                    ArrayList<CreatePartitionsTopicResult> newCollection = new ArrayList<>(arrayLength);
    ...
    @Override
    public CreatePartitionsResponseData duplicate() {
        CreatePartitionsResponseData _duplicate = new CreatePartitionsResponseData();
        _duplicate.throttleTimeMs = throttleTimeMs;
        ArrayList<CreatePartitionsTopicResult> newResults = new ArrayList<CreatePartitionsTopicResult>(results.size());
        for (CreatePartitionsTopicResult _element : results) {
    ...
    public static class CreatePartitionsTopicResult implements Message {
        String name;
        short errorCode;
        String errorMessage;
        private List<RawTaggedField> _unknownTaggedFields;
        ...
        @Override
        public CreatePartitionsTopicResult duplicate() {
            CreatePartitionsTopicResult _duplicate = new CreatePartitionsTopicResult();
